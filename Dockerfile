...
RUN chmod g+x /usr/sbin/install_packages
RUN ls -ld /usr/sbin/install_packages
...
RUN . /opt/bitnami/scripts/libcomponent.sh && component_unpack "php" "7.4.21-0" --checksum cd407e914d11706babacc6a95070cbe96f41f0cef11e879e0d14b666d8be5e64
...
RUN ls -ld /opt/bitnami

COPY rootfs /

RUN chmod g+x /opt/bitnami/scripts/mysql-client
...
ENV ALLOW_EMPTY_PASSWORD="no" \
    ...
    BITNAMI_IMAGE_VERSION="5.7.2-debian-10-r43" \
